...
_contacts_configs = {
    ...
    "delve": dict(
        home_sar=0.3, work_sar=0.045, other_sar=0.045, period=10, asymp_factor=0.5, p_vaccinated=0.25, vaccine_efficacy=0.7, vaccine_strategy='gov'
    ),
}
...
_case_configs = {
    ...
    "kucharski": dict(
        p_for_categories=[.1, .1, .1, .1, .2, .2, .2],
        # following Kucharski.
